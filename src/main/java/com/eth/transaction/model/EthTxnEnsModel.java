...
@Entity
@Table(name = "eth_txns_ens")
@Data
public class EthTxnEnsModel {
    ...
    public EthTxnEnsModel(EthBlock.TransactionObject ta) {
        ...
        if(ta.getType() != null){
            this.type = Integer.valueOf(ta.getType());
        }

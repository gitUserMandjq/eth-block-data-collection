...
public class OkHttpClientUtil {
     ...
     * @return {@link Response}
     */
    public Response getData(OkHttpClient client,String url) {
        // 构造 Request
     ...
     *
     * @param url        请求地址
     * @param requestParamStr 请求参数
     * @return {@link Response}
     */
    public Response postData(String url, String requestParamStr) {
        MediaType mediaType = MediaType.parse("application/json");
        // 构造 RequestBody
        RequestBody body = RequestBody.create(mediaType, requestParamStr);
        // 构造 Request
        Request.Builder requestBuilder = new Request.Builder();
        Request request = requestBuilder.post(body)
                .addHeader("Accept", "application/json")
     ...
     * @param myNetCall  回调函数
     */
    public void postDataAsync(String url, Map<String, Object> bodyParams, final MyNetCall myNetCall) {
        // 构造 RequestBody
        RequestBody body = setRequestBody(bodyParams);
        // 构造 Request
